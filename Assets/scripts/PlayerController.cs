...
public class PlayerController : MonoBehaviour {
	...
	void Start () {	
		...
		/*
		GameObject player = Instantiate(Resources.Load("Player")) as GameObject;  // instatiate the object
		player.transform.SetParent (Playerl1, false);
		...
		*/
		...
		player5.transform.localScale = new Vector3(1f, 1f, 1f);
		...
		player6.transform.localScale = new Vector3(1f, 1f, 1f);
